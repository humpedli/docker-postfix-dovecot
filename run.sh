...
sed -i "s/user =.*/user = ${MYSQL_USER:-mail}/g" /etc/postfix/*
sed -i "s/password =.*/password = ${MYSQL_PASSWORD:-mail}/g" /etc/postfix/*
sed -i "s/hosts =.*/hosts = ${MYSQL_HOST:-localhost}/g" /etc/postfix/*
sed -i "s/dbname =.*/dbname = ${MYSQL_DATABASE:-mail}/g" /etc/postfix/*
